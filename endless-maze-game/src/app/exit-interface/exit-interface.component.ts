...
export class ExitInterfaceComponent implements OnInit {
  ...
  defaultText: string = "The closed wooden door is inset into the hedge. There is a sign beside the door that says \"Return book here\" with a slot beneath it.";
  ...
  examineSlotText: string = "The slot is about a foot long and a few inches tall. It is completely dark inside, and you can't feel anything interesting inside it. Your book will easily fit in this slot."
